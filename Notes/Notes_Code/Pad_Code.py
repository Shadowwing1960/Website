...
def note_pad():
    ...
    def open_file():
        fp = r"C:/Users/HP Admin/PycharmProjects/Website/Notes/Notes_Storage/"
    ...
    def save_file():
        ns = r"C:/Users/HP Admin/PycharmProjects/Website/Notes/Notes_Storage"
        with open(file_name.value + ".txt", "w") as f:
            f.write(editor.value)
            f.close()
            fl = r"C:/Users/HP Admin/PycharmProjects/Website/Web"
    ...
    PushButton(file_controls, text="Exit", command=exit, align="right")
